            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" bounceInDown text-white">Donate Blood & Save a Life</h5>
                        ...
                        <div class=" vbh">
                            ...
                            <div class="btn btn-danger bounceInUp">
                                <a href="{{route('donor#createPage')}}" class="text-white text-decoration-none"> Become a volunteer </a></div>

                            <div class="btn btn-danger bounceInUp">
                                <a class="text-white text-decoration-none" href="#contact"> Contact US </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        ...
                        <div class=" vbh">
                            ...
                            <div class="btn btn-danger  bounceInUp">
                                <a href="{{route('appointment#createPage')}}" class="text-white text-decoration-none"> Book Appointment </a>
                            </div>
                            <div class="btn btn-danger bounceInUp">
                                <a class="text-white text-decoration-none" href="#contact"> Contact US </a>
                            </div>
