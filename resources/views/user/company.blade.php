                        ...
                        <div class="login-wrap">
                            <div class="login-content">
                                ...
                                <div class="login-form">
                                    <form action="{{ route('company#create') }}" method="post" novalidate="novalidate"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="companyName" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="companyEmail" type="text"
