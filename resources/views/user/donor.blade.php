                        ...
                        <div class="login-wrap">
                            <div class="login-content">
                                <div class="login-logo">
                                    <h1 class="text-danger">Donor Registration</h1>
                                </div>
                                <div class="login-form">
                                    <form action="{{ route('donor#create') }}" method="post" novalidate="novalidate"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="firstName" type="text"
                                                value="{{ old('firstName') }}"
                                                class="form-control @error('firstName') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false" placeholder="Enter First Name...">
                                            @error('firstName')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="lastName" type="text"
                                                value="{{ old('lastName') }}"
                                                class="form-control @error('lastName') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false" placeholder="Enter Last Name...">
                                            @error('lastName')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="dob" type="date" value="{{ old('dob') }}"
                                                class="form-control @error('dob') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false"
                                                placeholder="Enter Last Donated Blood...">
                                            @error('dob')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="weight" type="text"
                                                value="{{ old('weight') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="allergy" type="text"
                                                value="{{ old('allergy') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="disease" type="text"
                                                value="{{ old('disease') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="lastDonatedBlood" type="date"
                                                value="{{ old('lastDonatedBlood') }}"
