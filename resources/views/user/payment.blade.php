...
@section('content')
    ...
    <body>
        ...
        <body class="animsition">
            <form class="my-5 pb-5" action="{{ route('payment#create') }}" method="post" novalidate="novalidate"
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-12">
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control @error('cardNumber') is-invalid @enderror"
                                            name="cardNumber" type="text" placeholder="1234 5678 435678"
                                ...
                                <div class="col-6">
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control @error('expiryDate') is-invalid @enderror"
                                            name="expiryDate" type="month" placeholder="MM/YYYY"
                                ...
                                <div class="col-6">
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control @error('securityNumber') is-invalid @enderror"
                                            name="securityNumber" type="password" placeholder="***">
                                ...
                                <div class="col-12">
                                    <button id="payment-button" type="submit"
                                        class="btn btn-lg btn-danger btn-block mb-3">
