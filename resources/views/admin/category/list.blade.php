                ...
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">Blood Types</h2>
                        ...
                        <div class="table-data__tool-right">
                            <a href="{{ route('category#createPage') }}">
                                <button class="btn btn-sm btn-danger btn-block">
                                    <i class="zmdi zmdi-plus"></i> Add Blood Type
                                </button>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-2 offset-10 text-danger p-2 text-right">
                            <h4> <i class="fa-solid fa-droplet"></i> ( {{ $categories->total() }} ) </h4>
                        </div>
                    </div>
                            ...
                            <table class="table table-data2 text-center">
                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr class="tr-shadow">
                                            <td> {{ $category->id }} </td>
                                            <td class="col-6"> {{ $category->blood_type }} </td>
