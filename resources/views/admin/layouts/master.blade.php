                    ...
                    <ul class="list-unstyled navbar__list">
                        <li>
                            <a href="{{route('category#list')}}" class="text-decoration-none">
                                <i class="fa-solid fa-droplet"></i>Blood Groups
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin#contactList') }}" class="text-decoration-none">
                                <i class="fa-solid fa-message"></i> Contact Requests</a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h4>
                                    <i class="fa-solid fa-laptop"></i> Admin Control Center
                                </h4>
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#list') }}" class="text-decoration-none">
                                                        <i class="fa-solid fa-users me-2"></i>Admin List</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
